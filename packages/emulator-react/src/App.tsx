...
const getWord = (memory: Uint8Array, addr: number) =>
...
export const App: React.FC = () => {
  ...
  const z_FP = useMemo(
    () => (emulationState ? getWord(emulationState.memory, 0) : 0),
    [emulationState],
  );
  const z_PTR = useMemo(
    () => (emulationState ? getWord(emulationState.memory, 2) : 0),
    [emulationState],
  );
          ...
          {Array.from(
            ...
            <div
              ...
              className={clsx("memory-cell", {
                ...
                "memory-cell-ptr":
                  rowAddress + index === z_PTR ||
                  rowAddress + index === z_PTR - 1,
                "memory-cell-fp": rowAddress + index === z_FP,
                "memory-cell-hover":
                  addrHover !== null && rowAddress + index === addrHover,
              })}
            >
                ...
                <div className="info-field">
                  ...
                  <Input
                    value={addrTarget
                      ...
                      .toUpperCase()}
                    onChange={(e) =>
                      setAddrTarget(parseInt(e.target.value, 16))
                    }
                    style={{
                      width: "60px",
                      textAlign: "center",
