...
; rotate left with overflow 1
      JPS _Print "rotLeft 0x80 1: ",0
      JAS init_test
      LDI 0x80
      RL1
      JAS dump

; rotate left with overflow 0
      JPS _Print "rotLeft 0x80 3: ",0
      JAS init_test
      LDI 0x80
      RL3
      JAS dump
...
; rotate left with overflow 0
      JPS _Print "rotLeft 196 6: ",0
      JAS init_test
      LDI 196
      RL6
      JAS dump

; rotate right with overflow 1
      JPS _Print "rotRight 1 1: ",0
      JAS init_test
      LDI 0x01
      RR1
      JAS dump
