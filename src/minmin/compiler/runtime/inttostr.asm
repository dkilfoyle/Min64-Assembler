...
__inttostr:			CLB __intstr													; PRINT A 16-BIT REGISTER AS DEC NUMBER
                ...
                RL1 FCC __intnotneg
                  NEV z_C LDI '-' SDB __intstr                 ; negative sign
  __intnotneg:		LDI <__intstr+5 SDB __strptr+0			                 ; point to last digit of output string
                LDI >__intstr+5 SDB __strptr+1
  ...
  __intdone:		  DEZ z_cnt FNE __intshift
                  ...
                  ADI '0' SDR __strptr DEW __strptr   	           ; store remainder as char
