...
import { AsmDebugSession } from "./MinAsmDebugSession.ts";
...
export class MinAsmRuntime {
  ...
  getEmulatorState(): IEmulatorState {
    EmulatorWebviewPanel.postMessage("getEmulatorState", {});
...
export const asmRuntime = new MinAsmRuntime();
