...
; *****                                 *****
; *******************************************
              LDI 0xfe STB 0xffff        ; init stack
...
state_intro:  INB _RandomState+0         ; randomize pseudo-random generator
  ...
  cfloop:       LDI '.' STR ptr
                ...
                BCC cfloop
                  ...
                  CLB _XPos LDI 3 STB _YPos
                  JPS _Print ' CONTROLS', 10, 10
                             ' A - Left', 10
                             ' D - Right', 10
                             ' W - Rotate', 10
                             ' S - Drop', 0
                  LDI 28 STB _XPos LDI 3 STB _YPos
...
state_run:    JPS _ReadInput CPI 0 BEQ run_nokey ; non-blocking key input
      ...
      w_key:      INB _RandomState+2
                  ...
                  LDB xpos INC STB xpos PHS LDB ypos PHS JPS TestShape PLS PLS DEC BCS r_drshape ; and possible wall kicks
                  LDB xpos SUI 2 STB xpos PHS LDB ypos PHS JPS TestShape PLS PLS DEC BCS r_drshape
                  LDB xpos ADI 3 STB xpos PHS LDB ypos PHS JPS TestShape PLS PLS DEC BCS r_drshape
                  LDB xpos SUI 4 STB xpos PHS LDB ypos PHS JPS TestShape PLS PLS DEC BCS r_drshape
  ...
  rpcopydone:   DEB vary
                BNE rpyloop
                  ...
                  BNE rpnewhigh
                    ...
                    CPB highscore+0
                    BCC rpnewshape
  rpnewhigh:          LDB score+0 STB highscore+0             ; score = highscore
                      LDB score+1 STB highscore+1
...
NewShape:     LDI <nextshape STB ptr+0                        ; copy nextshape into shape
              ...
              LDI 9 STB vari                                  ; copy including xoff
  ...
  rndagain:   JPS _Random ANI 7 CPI 7 BCS rndagain            ; 0..6
              STB vari LL3 ADB vari   ; x 9
              ADW ptr
              LDI 9 STB vari                                  ; size including xoff
  nscpylp:    LDR ptr STR ptr2
              INW ptr INW ptr2
...
PrintShape:   LDI >shape STB ptr+1
              LDI <shape STB ptr+0
              LDI 4 STB vari
  psloop:     LDB xpos ADI 14 ADR ptr STB _XPos
              INW ptr
              LDB ypos ADR ptr STB _YPos
...
PrintNext:    LDI >nextshape STB ptr+1
              LDI <nextshape STB ptr+0
              LDI 4 STB vari
  pnloop:     LDI 31 ADR ptr STB _XPos
              INW ptr
              LDI 6 ADR ptr STB _YPos
              LDB shapechar JAS _Char
              INW ptr         ; next square
              DEB vari
              BNE pnloop
...
; pull: #, #
U16_Text:       LDS 3 STB U16_C+1  ; PRINT A POSIMIVE NUMBER
                LDS 4 STB U16_C+0
                LDI 0 PHS STB U16_digits
  U16_start:    CLB U16_C+2
                LDI 16 STB U16_count
  U16_shift:    LDB U16_C+2 RL1
                LDB U16_C+0 RL1 STB U16_C+0
                LDB U16_C+1 RL1 STB U16_C+1
                LDB U16_C+2 RL1 STB U16_C+2
                CPI 10 BCC U16_done
                  ADI 118 STB U16_C+2
...
highscore:    0x07e8                     ; holding the current highscore 10.5.2021
